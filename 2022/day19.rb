...
def crack_geodes(blueprint, time_allowed=24)
    ...
    while not states.empty?
        ...
        states.each do |state|
            ...
            if can_buy_orebot and state.ore_robots < max_orebots_needed
            ...
            if can_buy_claybot and state.clay_robots < max_claybots_needed
            ...
            if can_buy_obsidibot and state.obsidian_robots < max_obsidibots_needed
